---
name: github-pr-ops
description: Use when the user asks to publish or maintain the PR for a stack-agnostic backend work item.
---
...
- Keep readiness and risk notes visible in the PR body.
